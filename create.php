  ...
  <main>
    <div class="row g-5">
      <div class="col-md-7 col-lg-8">
        ...
        <form action="create-job.php" method="post" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-12">
              <label for="empleo" class="form-label">Empleo</label>
              <input type="text" class="form-control" id="empleo" name="empleo" placeholder="" value="" required>
            </div>
            <div class="col-12">
          ...
          <button class="btn btn-lg btn-outline-secondary w-100" type="submit">Crear Empleo</button>
        </form>
      </div>
    </div>
  </main>

...
<body>
  ...
  <main>
    <div class="row g-5">
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Editar Empleo</h4>
        <?php //Entrega Resultado
        while ($row = $resultado->fetch_assoc()) {
        ?>
          <form action="edit-job.php" method="post" class="test-edit needs-validation" novalidate>
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <textarea rows="5" cols="10" class="form-control" id="descripcion" name="descripcion" placeholder="" required><?php echo $row['descripcion'] ?></textarea>
              </div>
              <div class="col-12">
            ...
            <button class="btn btn-lg btn-outline-secondary w-100 mt-20" type="submit">Editar Empleo</button>
          <?php
        }
        $conn->close();
          ?>
  ...
  <footer class="fixed-bottom text-muted p-3 mb-2 test-background-out bottom-0 text-dark bg-opacity-50">
    <div class="container">
